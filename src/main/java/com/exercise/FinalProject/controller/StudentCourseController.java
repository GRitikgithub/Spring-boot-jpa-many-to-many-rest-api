...
public class StudentCourseController {
   ...
   @PutMapping("students/{studentId}/course/{courseId}")
    public String update(@PathVariable Integer studentId, @PathVariable Integer courseId,@RequestBody StudentCourse studentCourse){
        this.studentCourseService.updateCourse(studentId,courseId,studentCourse);
